    ...
    methods: {
      ...
      handleLogin() {
            ...
            login(this.loginForm.username, this.loginForm.password).then(response => {
              ...
              // console.log("登录成功数据保存到store");
              // console.log(this.$store.state.user.userId+"获取的id");
              // console.log(this.$store.state.user.userName+"获取的name");
              // console.log(this.$store.state.user.avatar+"获取的头像");
